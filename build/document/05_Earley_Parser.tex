...
be \isa{item\ e} $= N \rightarrow \, \alpha \bullet \beta, j, k$.
...
\begin{itemize}
  ...
  \item \isa{pointer\ e\ {\isacharequal}{\kern0pt}\ Pre\ pre}:
    ...
    Since the pointer is a simple predecessor pointer, \isa{scans\ {\isasymomega}\ k\ x{\isacharprime}{\kern0pt}\ x} holds and $x$ as well
...
\ wf{\isacharunderscore}{\kern0pt}rule{\isacharunderscore}{\kern0pt}root{\isacharunderscore}{\kern0pt}yield{\isacharunderscore}{\kern0pt}build{\isacharunderscore}{\kern0pt}tree{\isacharcolon}{\kern0pt}\ %
...
well-formed, we can discharge the assumptions of the previous two lemmas, obtain \isa{t\ {\isacharequal}{\kern0pt}\ Branch\ N\ ts} and have:
