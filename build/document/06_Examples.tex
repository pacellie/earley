...
\isa{build{\isacharunderscore}{\kern0pt}trees}. But first we make a small addition to easily compute if a grammar allows empty
...
\isa{build{\isacharunderscore}{\kern0pt}trees} for the well-formed grammar \isa{{\isasymG}} and input \isa{{\isasymomega}} introduced above.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
